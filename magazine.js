...
function setup() {
    ...
    if(entrylog === null) {
        ...
        alert("Hello, welcome to the website! Before you begin, please note that the website is optimized for computers but also works on touch devices. The top right button is to enter or exit fullscreen mode!");
    ...
    if(entrylog === 2) {
        ...
        alert("Six, that is how many fingers Krithik Roshan hand has, what a mutant (Ninja Turtle)!");
    }else if(entrylog === 10) {
        ...
        alert("Triple digit! Jobless person, you just reached a 100 visits! I ain't gonna reward you for such behaviour, no easter eggs from now on!");
    }
